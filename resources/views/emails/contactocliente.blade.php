                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 150%; text-align: center;"><span style="font-size: 16px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;"><strong>Tienes un nuevo correo de contacto desde enviado desde la pagina de www.elmana.com.gt, la información enviada es la siguiente:</font></strong></span>
                                                                                                                            <ul>
                                                                                                                                <li>Nombre: {{ $name }}</li>
                                                                                                                                ...
                                                                                                                                <br><span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;">Contacta a la persona por medio de los datos proporcionados por él para resolver sus dudas.</span>
                                                                                                                            </ul>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
