                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 150%; text-align: center;">
                                                                                                                            ...
                                                                                                                            <strong><font font color="black"><h1>Order Cancelled  </h1></font></strong
                                                                                                                                <strong><font font color="black">We have cancelled  your order in www.mapitgo.com, you can check if the order was cancelled correctly and keep track of it by logging into your account:</font></strong>
                                                                                                                            </span>
                                                                                                                            <ul>
                                                                                                                                <li>name: {{ $name }}</li>
                                                                                                                                <li>User: {{ $email }}</li>
                                                                                                                                <li>Work ID: {{ $workid }}</li>
                                                                                                                                <br><span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;">To access your account just enter our website from the following link and go to the section to login: </span>
                                                                                                                            </ul>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
