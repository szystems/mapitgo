                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 150%; text-align: center;">
                                                                                                                            ...
                                                                                                                            <strong><font font color="black"><h1>Order Finalized </h1></font></strong
                                                                                                                                <strong><font font color="black">We have Finalized your order in www.mapitgo.com, you can see the details of it by logging into your account:</font></strong>
                                                                                                                            </span>
                                                                                                                            <ul>
                                                                                                                                <li>name: {{ $name }}</li>
                                                                                                                                <li>User: {{ $email }}</li>
