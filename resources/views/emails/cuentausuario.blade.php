                            ...
                            <tr>
                                <td name="bmeMainColumnParent" style="border: 0px none transparent; border-radius: 0px; border-collapse: separate;">
                                    <table name="bmeMainColumn" class="bmeHolder bmeMainColumn" style="max-width: 600px; border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: visible;" cellspacing="0" cellpadding="0" border="0" align="center">
                                        <tbody>
                                            <tr>
                                                <td width="100%" class="blk_container bmeHolder" name="bmePreHeader" valign="top" align="center" style="color: rgb(102, 102, 102); border: 0px none transparent; background-color: rgb(0,0,0);" bgcolor="#000000"></td>
                                            </tr>
                                            <tr>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 15px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
																														<div style="line-height: 150%; text-align: right;"><span style="font-size: 12px; font-family: 'Courier New', Courier; color: #ffffff; line-height: 150%;"><span style="text-decoration: underline; line-height: 150%;">
																															<a href="{{ url('/') }}"><p class="site"><font color="white">www.mapitgo.com</font></p></a></span></span>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="center" class="bmeImage" style="border-collapse: collapse; padding: 20px;"><a href="{{ url('/') }}"><img src="{{asset('/mapitgo/images/logo.png')}}" alt="Map It Go!" height="100"></a></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                    </td>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 150%; text-align: center;">
                                                                                                                            ...
                                                                                                                            <strong><font font color="black"><h1>User Account </h1></font></strong
                                                                                                                                <strong><font font color="black">we have created an account in www.mapitgo.com, then your credentials will be shown to be able to enter and manage your orders:sde nuestra página, los datos para ingresar a tu cuenta son los siguientes:</font></strong>
                                                                                                                            </span>
                                                                                                                            <ul>
                                                                                                                                <li>name: {{ $nombre }}</li>
                                                                                                                                <li>User: {{ $email }}</li>
                                                                                                                                <li>Password: {{ $contrasena }}</li>
                                                                                                                                <br><span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;">To access your account just enter our website from the following link and go to the section to log in: </span>
                                                                                                                            </ul>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center">
                                                                                                        <table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="center" style="border-collapse: separate;">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td style="border-radius: 0px; border: 3px solid rgb(0,0,0); text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: bold; border-collapse: separate;" class="bmeButtonText"><span style="font-family: 'Courier New', Courier; font-size: 14px; color: rgb(66, 66, 66);"><a href="{{ url('/login') }}" style="color: rgb(66, 66, 66); text-decoration: none;" target="_blank">Go to website</a></span></td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                    </td>
                                                                                            ...
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center">
                                                                                                        <table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="center" style="border-collapse: separate;">
                                                                                                            <tbody>
                                                                                                                <p>or if you have a comment you can leave it in the following link</p>
                                                                                                                <tr>
                                                                                                                    <td style="border-radius: 0px; border: 3px solid rgb(0,0,0); text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: bold; border-collapse: separate;" class="bmeButtonText"><span style="font-family: 'Courier New', Courier; font-size: 14px; color: rgb(66, 66, 66);"><a href="{{ url('/vistas/vcontacto') }}" style="color: rgb(66, 66, 66); text-decoration: none;" target="_blank">Contact</a></span></td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                    </td>
                                                                                                                    ...
                                                                                                                    <td valign="top" name="bmeSocialTD" class="bmeSocialTD">
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left" class="bmeFollowItemIcon" gutter="20" width="24" style="padding-right:20px;height:20px;">
                                                                                                                                        <a href="https://www.facebook.com/mapit.go" target=_blank style="display: inline-block;background-color: rgb(0,0,0);border-radius: 0px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img src="{{asset('/img/fb.png')}}" alt="Facebook" style="display: block; max-width: 114px;" border="0" width="24" height="24"></a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                        </table>
                                                                                                                        ...
                                                                                                                        <table cellspacing="0" cellpadding="0" border="0" class="bmeFollowItem" type="Instagram" style="float: left; display: block;" align="left">
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left" class="bmeFollowItemIcon" gutter="20" width="24" style="padding-right:20px;height:20px;">
                                                                                                                                        <a href="https://www.instagram.com/mapitgo/" target=_blank style="display: inline-block;background-color: rgb(0,0,0);border-radius: 0px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img src="{{asset('/img/insta.png')}}" alt="Instagram" style="display: block; max-width: 114px;" border="0" width="24" height="24"></a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                        </table>
