	...
	<div class="card-body">
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				@include('reports.bitacora.search')
                ...
                {{Form::token()}}
					...
					<div class="card mb-4">
						<div class="card-body">
							...
							<h6><strong>Filtros:</strong><font color="Blue"> <strong>Date:</strong> '{{ $fecha}}', <strong>User:</strong> '@foreach($usufiltro as $usuf){{$usuf->name}}@endforeach', <strong>Type:</strong> '{{ $tipo}}'</font></h6>
						</div>
					</div>
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-condensed table-hover">
						<thead>
							...
							<th><h5><strong>User</strong></h5></th>   
						...
						<tr>
							<td align="left">
								...
								<a href="{{URL::action('BitacoraController@show',$bit->idbitacora)}}" target="_blank">
									<span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="View Log">
							...
							<?php
								$fecha = date("m-d-Y", strtotime($bit->fecha));
							?>
