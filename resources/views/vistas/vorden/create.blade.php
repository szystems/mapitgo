				...
				<div class="col-lg-10">
                    ...
                    <div class="card mb-4">
                        <header class="card-header">
                            <h2 class="h3 card-header-title"><strong>Create Order</strong></h2>     
                        </header>
                        ...
                        <div class="card-body">
                            ...
                            {!!Form::open(array('url'=>'vistas/vorden','method'=>'POST','autocomplete'=>'off'))!!}
                            {{Form::token()}}
                            <div class="row">
                                <input type="hidden" name="idclient" class="form-control" id="idclient" value="{{ Auth::user()->id}}">
                                ...
                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <p>You can choose a point on the map or if you know directly the latitude and longitude you can put it directly in the corresponding fields, you can also go to <a target="_blank" href="https://www.google.com/maps">Google Maps</a> to collect the information and copy it. If not directly put the address in the corresponding field and an agent will add the coordinates for you.</p>
