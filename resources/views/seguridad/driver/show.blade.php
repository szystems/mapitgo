...
<div>
      <div class="card mb-4">
            ...
            {{Form::open(array('action' => 'ReportesController@vistadriver','method' => 'POST','role' => 'form', 'target' => '_blank'))}}
            ...
            <div class="card-body">
                @if(Auth::user()->user_type == "ADMIN")
                    <a href="{{URL::action('DriverController@edit',$usuario->id)}}">
                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Edit Driver">
			...
			@include('seguridad.driver.modaleliminarshow')
