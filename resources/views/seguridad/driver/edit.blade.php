...
<div class="col-md-6 mb-4">
      <div class="card">
            <header class="card-header">
                  <h2 class="h3 card-header-title"><strong>Edit Driver: {{ $usuario->name}} </strong></h2>
            </header>
            ...
            <div class="card-body">
                  ...
                  {!!Form::model($usuario,['method'=>'PATCH','route'=>['driver.update',$usuario->id],'files'=>'true'])!!}
                  {{Form::token()}}
                  ...
                  <?php
                        $birthday = date("d-m-Y", strtotime($usuario->birthday));
                  ?>
                  <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                        <label for="birthday"><font color="orange">*</font>Birthday</label>
                        <span class="form-icon-wrapper">
                              <span class="form-icon form-icon--right">
                                    <i class="fas fa-calendar-alt form-icon__item"></i>
                              </span>
                              <input type="text" id="birthday" class="form-control datepicker" name="birthday" value="{{$birthday}}">
                        </span>
                  </div>
                  <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        <label for="email">Email <font color="orange">*This field cannot be edited</font></label>
                        <input id="email" type="text" class="form-control" name="email" value="{{$usuario->email}}" readonly>
                        @if ($errors->has('email'))
                              <span class="help-block">
                                    <strong>
                                          {{ $errors->first('email') }}
                  ...
                  <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                        ...
                        <input id="phone" type="text" class="form-control" name="phone" value="{{$usuario->phone}}">
                        @if ($errors->has('phone'))
                              <span class="help-block">
                                    <strong>
                                          {{ $errors->first('phone') }}
                  ...
                  <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                        ...
                        <input id="address" type="text" class="form-control" name="address" value="{{$usuario->address}}">
                  ...
                  <div class="form-group{{ $errors->has('driver_license_number') ? ' has-error' : '' }}">
                        ...
                        <input id="driver_license_number" type="text" class="form-control" name="driver_license_number" value="{{$usuario->driver_license_number}}">
                  ...
                  <?php
                        $expiration = date("d-m-Y", strtotime($usuario->expiration_day));
                  ?>
                  <div class="form-group{{ $errors->has('expiration_day') ? ' has-error' : '' }}">
                        ...
                        <span class="form-icon-wrapper">
                              ...
                              <input type="text" id="expiration_day" class="form-control datepicker" name="expiration_day" value="{{$expiration}}">
                        </span>
                  </div>
                  <div class="form-group{{ $errors->has('issuing_state') ? ' has-error' : '' }}">
                        <label for="issuing_state">Issuing State</label>
                        <select id="issuing_state" type="text" class="form-control" name="issuing_state" value="{{$usuario->issuing_state}}">
                              <option selected="selected" value="{{$usuario->issuing_state}}">{{$usuario->issuing_state}}</option>
                  ...
                  <div class="form-group{{ $errors->has('ssn') ? ' has-error' : '' }}">
                        ...
                        <input id="ssn" type="text" class="form-control" name="ssn" value="{{$usuario->ssn}}">
                        @if ($errors->has('ssn'))
                              <span class="help-block">
                                    <strong>
                                          {{ $errors->first('ssn') }}
                  ...
                  <div class="form-group{{ $errors->has('user_type') ? ' has-error' : '' }}">
                        ...
                        <select id="user_type" type="text" class="form-control" name="user_type" value="{{$usuario->user_type}}">
                            <option selected="selected" value="{{$usuario->user_type}}">{{$usuario->user_type}}</option>
