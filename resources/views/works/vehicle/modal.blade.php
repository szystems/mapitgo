...
<!-- Basic Modals -->
		<div class="modal fade" data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="modal-delete-{{$vehi->idvehicle}}">
			{{Form::Open(array('action'=>array('VehicleController@destroy',$vehi->idvehicle),'method'=>'delete'))}}
