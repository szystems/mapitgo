...
class BitacoraController extends Controller
{
    ...
    public function index(Request $request)
    {
            if ($request)
            {
                ...
                return view('reports.bitacora.index',["bitacora"=>$bitacora,"fecha"=>$fecha,"tipo"=>$tipo,"usuario"=>$usuario,"usuarios"=>$usuarios,"usufiltro"=>$usufiltro,"hoy"=>$hoy]);
            }
    ...
    public function show($id)
    {
        ...
        return view("reports.bitacora.show",["bitacora"=>$bitacora]);
    }
}
