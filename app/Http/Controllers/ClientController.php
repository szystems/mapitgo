...
class ClientController extends Controller
{
    ...
    public function index (Request $request)
	{
		if ($request)
		{
			...
			->orderBy('name','asc')
			->paginate(20);
			return view('seguridad.client.index',["usuarios"=>$usuarios,"searchText"=>$query]);
		}
	}

	public function create()
	{
		return view("seguridad.client.create");
	}
    ...
    public function store(UsuarioFormRequest $request)
    {
    	...
    	return Redirect::to('seguridad/client');
    }

    public function edit($id)
    {
    	return view("seguridad.client.edit",["usuario"=>User::findOrFail($id)]);
    }
    ...
    {
        return view("seguridad.client.show",["usuario"=>User::findOrFail($id)]);
    }
